...
class _SportsLessonsPageState extends State<EditSportsLessonsPage> {
  ...
  Future<void> deleteClass(String classId) async {
    final apiUrl = Uri.parse('http://192.168.0.111:5000/class/$classId'); // Update the server URL and endpoint
    try {
  ...
  Future<void> updateClass(String classId, Map<String, dynamic> updatedData) async {
    final apiUrl = Uri.parse('http://192.168.0.111:5000/updateClass/$classId'); // Update the server URL and endpoint
    try {
          ...
          children: <Widget>[
            ...
            Row(
              children: [
                ...
                SizedBox(width: 280), // إضافة مسافة أفقية بين الأيقونات
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      IconButton(
                        icon: Icon(Icons.edit, color: Colors.black26), // Edit icon
                        onPressed: () {
                      ...
                      IconButton(
                        icon: Icon(Icons.delete, color: Colors.black26), // Delete icon
                        onPressed: () {
...
class LinearProgressContainer extends StatelessWidget {
  ...
  LinearProgressContainer({required this.value, required this.color});
