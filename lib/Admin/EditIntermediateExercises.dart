...
class _WorkoutDetailViewState extends State<intermediateExercises> {
  ...
  Future<void> registerUser() async {
    if (description.text.isNotEmpty &&
      ...
      final apiUrl = Uri.parse('http://192.168.0.111:5000/addIntermedate'); // Update the server URL
      try {
  ...
  Future<void> deleteExercise(String exerciseId) async {
    final apiUrl = Uri.parse('http://192.168.0.111:5000/intermediate/$exerciseId');
    try {
