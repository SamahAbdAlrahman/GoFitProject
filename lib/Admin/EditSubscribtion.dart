...
fetchSubscriptionOptions();          print('Failed to add subscription: ${response.body}');
  ...
  Future<void> deleteClass(String classId) async {
    final apiUrl = Uri.parse('http://192.168.0.111:5000/subscribtion/$classId'); // Update the server URL and endpoint
    try {
          ...
          content: Column(
            ...
            children: <Widget>[
              ...
              TextField(
                ...
                decoration: InputDecoration(labelText: 'Subscription Period'),
              ),
            ],
          ),
          actions: <Widget>[
...
class SubscriptionOptionBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(bottom: 50.0, right: 30, left: 30),
      decoration: BoxDecoration(
