...
class _WorkoutDetailViewState extends State<YogaExercises> {
  ...
  Future<void> registerUser() async {
    if (description.text.isNotEmpty &&
      ...
      final apiUrl = Uri.parse(addyoga); // Update the server URL
      try {
  ...
  Future<List<ExerciseItem>> fetchExercises() async {
    final apiUrl = Uri.parse('http://192.168.0.111:5000/yogaexercises'); // Replace with your API endpoint
  ...
  Future<void> deleteExercise(String exerciseId) async {
    final apiUrl = Uri.parse('http://192.168.0.111:5000/yoga/$exerciseId');
    try {
