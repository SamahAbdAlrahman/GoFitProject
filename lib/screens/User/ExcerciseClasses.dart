                      ...
                      showDialog(
                        ...
                        builder: (context) {
                          return AlertDialog(
                            ...
                            content: Text("Do you want to confirm the booking of this class"),
                            actions: [
                              TextButton(
                              onPressed: () async {
                              ...
                              if (response.statusCode == 200) {
                                ...
                                showDialog(
                                  ...
                                  builder: (context) {
                                    return AlertDialog(
                                      title: Text("Booking Confirmation"),
                                      content: Text("Failed to save the reservation to the database"),
                                      actions: [
                                        TextButton(
                                          onPressed: () {
                                            Navigator.of(context).pop();
                                ...
                                showDialog(
                                  ...
                                  builder: (context) {
                                    return AlertDialog(
                                      title: Text("Booking Confirmation"),
                                      content: Text(" Your reservation has been confirmed."),
                                      actions: [
                                        TextButton(
                                          onPressed: () {
                                            Navigator.of(context).pop();
