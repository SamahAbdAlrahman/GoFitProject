...
class SubscriptionOption extends StatelessWidget {
  ...
  SubscriptionOption({required this.price, required this.month, required this.isSelected});
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(bottom: 70.0, right: 30, left: 30),
      decoration: BoxDecoration(
    ...
    return Stack(
      children: <Widget>[
        Container(
          ...
          Text(' Your Subscription Valid', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
            SizedBox(height: 10),
            Row(children: [

              SizedBox(width: 10),

              Text('From: ${dateFormat.format(startDate)}',style: TextStyle(fontSize: 18, fontWeight: FontWeight.w400)),
              SizedBox(width: 10),

              Text('to: ${dateFormat.format(endDate)}',style: TextStyle(fontSize: 18, fontWeight: FontWeight.w400)),
            ],),
            SizedBox(height: 16),
            ElevatedButton(
              onPressed: () {
