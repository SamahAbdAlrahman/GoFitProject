...
class MenuCoach extends StatefulWidget {
  const MenuCoach({Key? key}) : super(key: key);
...
class _MenuCoachState extends State<MenuCoach> {
  int currentState = 0;
  List<Widget> widgets = [MenuCoach(), ProfileScreen()];
  ...
  List menuArr = [
    {
     ...
     {"name": "Add Exercises", "image": "assets/img/menu_exercises.png", "tag": "2"},
    {"name": "Add Tips", "image": "assets/img/menu_tips.png", "tag": "3"},
  ];
